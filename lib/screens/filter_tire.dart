...
class FilterTire extends StatefulWidget {
  @override
  _FilterTireState createState() => _FilterTireState();
}

class _FilterTireState extends State<FilterTire> {
  final String titleScreen = 'Pneu';

...
class FilterEletric extends StatefulWidget {
  @override
  _FilterEletricState createState() => _FilterEletricState();
}

class _FilterEletricState extends State<FilterEletric> {
  final String titleScreen = 'Elétrica';

  @override
  Widget build(BuildContext context) {
    List<ItemBannerListWidget> listBanner = DataBase().listBanner;
